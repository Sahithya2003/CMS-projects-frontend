...
export default function Sidebar() {
  ...
  return (
    <div class="flex flex-col items-center w-56 h-screen overflow-hidden text-gray-400 bg-gray-900  ">
      ...
      <div class="w-full px-2">
        <div class="flex flex-col items-center w-full mt-3 border-t border-gray-700">
          {/* <a
            class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300 focus:bg-[#e2e8f0] focus:text-gray-700"
            href="#"
          >
            <svg
          ...
          <a
            class="flex items-center w-full h-12 px-3 mt-2 hover:bg-gray-700 hover:text-gray-300 focus:bg-[#e2e8f0] focus:text-gray-700  rounded"
            href="#"
          >
            <svg
              class="w-6 h-6 stroke-current"
            ...
            <span class="ml-2 text-sm font-medium">Status Update</span>
          </a>
          <a
            class="flex items-center w-full h-12 px-3 mt-2 rounded hover:bg-gray-700 hover:text-gray-300 focus:bg-[#e2e8f0] focus:text-gray-700"
            href="#"
        ...
        <div class="flex flex-col items-center w-full ">
          ...
          >
            ...
            <span class="ml-2 text-sm font-medium">Hardware Logbook</span>
          </a>
          <a
